...
STICKERS = (
    "CAACAgUAAxkBAAMeYPB7Z3F4dnHVhgABE8lbsSQC3SYHAAIiAgACpdR4VxacxIBpFYwrHgQ",
    "CAACAgUAAxkBAAMhYPB7deMb4MtbauWI6fhvKoHKsIcAArgDAAJqc3lXgvzvFQ4pzwYeBA",
    "CAACAgUAAxkBAAMkYPB7gIpadducZN5zKIpBw4MWk7EAApkDAAKKNHlXkvjN-nKstBYeBA",
    "CAACAgUAAxkBAAMnYPB7mGfcQZfVbW-cXRs5AzB6pc0AAqUDAAJbjXhX_xHeFxfCOW8eBA",
    "CAACAgUAAxkBAAJOHmBeljjU0_FT_QpdUUJBqVUC0nfJAAKYAgACJ_jBVvntHY_8WF27HgQ",
    "CAACAgUAAxkBAAMqYPB7oTXsXL8Th4AlCNozLBZwBocAAmADAAL90nlXMNNNq8wAARKbHgQ",
    "CAACAgUAAxkBAAMtYPB7qD4SBDVZa2H8zEnuVT5wTJ4AAnQCAAJyPXhXKK_FulA_AvgeBA",
    "CAACAgUAAxkBAAMwYPB7sQkBhZZOBV04TAET3mN2aAQAAnsCAAJfx3FXvdHa4VJ-VugeBA",
    "CAACAgUAAxkBAAMzYPB7uBapsD9iPoSO9-dG1BZm2wQAAoQDAAKRxXBX1fLfyyHVCc4eBA",
    "CAACAgUAAxkBAAM2YPB7wuEzsdu3KkR3DSeO9Tl-RA4AAggDAAL9PnhXZeX4g09fasUeBA",
)
...
async def start_group_cmd(message, strings):
    await message.reply(strings["Hai yang disana! Nama saya **Dimas**.
Saya bisa membantu mengatur grup dengan fitur-fitur yang berguna, jangan ragu untuk menambahkan saya ke grup anda!"])
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings[Owner], url="https://t.me/xskull7/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["Blog ku], url="https://darkskull7.blogspot.com"),
        InlineKeyboardButton(
            strings["Website"], url="https://darkskull7.my.tol"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👥 Add Dimas Botz ke grup",
            url=f"https://telegram.me/dimasapabot?startgroup=true",
        )
    )
...
async def helpmenu_callback(query, callback_data=None, **kwargs):
    ...
    msg += f"{MOD_HELP[mod]}"
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text="🏃‍♂️Kembali", callback_data="get_help")
    )
    with suppress(MessageNotModified):
